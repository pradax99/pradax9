...
const translations = {
    ru: {
        ...
        "contact-location-text": "Abu Dhabi, U.A.E",
        "form-name": "Имя",
        "form-email": "Email",
    ...
    en: {
        ...
        "review6-text": "The calculator with advanced functions perfectly suited our needs. The interface is convenient, calculations are accurate.",
        "review6-role": "Financial Analyst",
        ...
        // Footer
        "footer-text": "2025 prada x 9. All rights reserved."
    },
    de: {
        // Navigation
        "nav-about": "Über mich",
        ...
        // Footer
        "footer-text": "© 2025 prada x 9. Alle Rechte vorbehalten."
    }
};
...
function addDynamicEffects() {
    ...
    // Анимация для карточек портфолио и отзывов
    const cards = document.querySelectorAll('.portfolio-item, .review-card');
